...
export const addProductWithInventory = async ({quantity, createdAt}: ProductInventoryDao) => {
  return await db.query('INSERT INTO product_inventory (quantity, created_at) VALUES ($1, $2) RETURNING id', [quantity, createdAt]);
};
...
export const deleteProductQuantity = async (id: number) => {
